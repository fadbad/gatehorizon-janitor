...
class ReactNativeModal extends Component {
    ...
    buildPanResponder = () => {
        ...
        this.panResponder = PanResponder.create({
                    ...
                    if (this.props.scrollTo) {
                        if (this.props.scrollHorizontal) {
                            ...
                            if (offsetX > this.props.scrollOffsetMax) {
                                offsetX -=
                                    (offsetX - this.props.scrollOffsetMax) / 2;
                            }
                            ...
                            if (offsetY > this.props.scrollOffsetMax) {
                                offsetY -=
                                    (offsetY - this.props.scrollOffsetMax) / 2;
                            }
            ...
            onPanResponderRelease: (evt, gestureState) => {
                ...
                const accDistance = this.getAccDistancePerDirection(
                    gestureState
                );
                if (
                    ...
                    if (this.props.onSwipeComplete) {
                        ...
                        this.props.onSwipeComplete({
                            swipingDirection: this.getSwipingDirection(
                                gestureState
                            )
                        });
                        return;
    ...
    open = () => {
        ...
        if (this.contentRef) {
            ...
            this.contentRef[this.animationIn](
