...
export async function showLocation(options) {
  ...
  let dialogTitle = options.dialogTitle && options.dialogTitle.length ? options.dialogTitle : 'Show Location Directions'
  let dialogMessage = options.dialogMessage && options.dialogMessage.length ? options.dialogMessage : 'Which app would you like to use?'
